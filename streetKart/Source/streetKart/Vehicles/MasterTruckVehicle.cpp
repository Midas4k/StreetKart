...
#include "MasterTruckVehicle.h"

AMasterTruckVehicle::AMasterTruckVehicle()
{
#pragma region Setting Meshes
	//SETTING DEFAULT HULL MESH
	ConstructorHelpers::FObjectFinder<USkeletalMesh> DefaultMeshSearch(TEXT("/Game/PolygonStreetRacer/Meshes/Vehicles_Rigged/Parts/SK_Veh_Truck_01"));
	...
	ConstructorHelpers::FObjectFinder<USkeletalMesh> SpoilerMeshSearch(TEXT("/Game/PolygonStreetRacer/Meshes/Vehicles_Rigged/Parts/SK_Veh_Truck_01_Spoiler_02"));
...
void AMasterTruckVehicle::BeginPlay()
{
