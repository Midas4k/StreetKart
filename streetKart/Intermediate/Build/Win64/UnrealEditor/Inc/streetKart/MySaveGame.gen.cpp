...
#include "streetKart/CheckpointSystem/MySaveGame.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMySaveGame() {}
// Cross Module References
	STREETKART_API UClass* Z_Construct_UClass_UMySaveGame_NoRegister();
	STREETKART_API UClass* Z_Construct_UClass_UMySaveGame();
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMySaveGame_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "CheckpointSystem/MySaveGame.h" },
		{ "ModuleRelativePath", "CheckpointSystem/MySaveGame.h" },
	};
#endif
	...
	template<> STREETKART_API UClass* StaticClass<UMySaveGame>()
	{
		return UMySaveGame::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMySaveGame);
	struct Z_CompiledInDeferFile_FID_streetKart_Source_streetKart_CheckpointSystem_MySaveGame_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_streetKart_Source_streetKart_CheckpointSystem_MySaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySaveGame, UMySaveGame::StaticClass, TEXT("UMySaveGame"), &Z_Registration_Info_UClass_UMySaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySaveGame), 689858317U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_streetKart_Source_streetKart_CheckpointSystem_MySaveGame_h_449825899(TEXT("/Script/streetKart"),
		Z_CompiledInDeferFile_FID_streetKart_Source_streetKart_CheckpointSystem_MySaveGame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_streetKart_Source_streetKart_CheckpointSystem_MySaveGame_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
